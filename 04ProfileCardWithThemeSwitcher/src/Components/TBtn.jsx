...
export default function TBtn() {
    ...
    const handleChange = (e) => {
        ...
        console.log('Toggle clicked, isChecked:', isChecked, 'current theme:', themeMode)
        if(isChecked) {
    ...
    console.log('TBtn render - themeMode:', themeMode, 'lightTheme:', typeof lightTheme, 'darkTheme:', typeof darkTheme)
